      ...
      <Row className="g-4 g-lg-5 align-items-start">
        ...
        <Col md={8} lg={9}>
          <div className="mb-4">
            ...
            <div className="d-flex flex-wrap align-items-center gap-2 text-secondary mb-3 justify-content-center justify-content-lg-start">
          ...
          <div className="d-flex flex-wrap gap-5 py-3 border-top border-bottom mb-4 justify-content-center justify-content-lg-start">
            <div>
